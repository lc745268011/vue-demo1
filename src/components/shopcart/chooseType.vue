<template>
  <div class="choose">
    <p class="title">请选择类型</p>
    <grid :cols="3">
      <grid-item :label="item.name" v-for="(item,index) in nineBox" :key="index" :link="item.url">
...
<style scoped>
  .title{padding: 0 30px;font-size: 20px;}
